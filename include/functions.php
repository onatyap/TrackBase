        ...
        foreach($result as $row){
            ...
            if(isMovie($conn,$row['content_id'])) {
            	if(isWatched($conn,$row['content_id'])){
            	 ...
            	 echo "<td> <form action='main_page_actions.php' method='post'> <input type='hidden' name='content_id' value=" . $row['content_id'] . "> <input type='submit' value='Select episodes to mark as watched' name='select_episodes'/> </form></td>";
            }
